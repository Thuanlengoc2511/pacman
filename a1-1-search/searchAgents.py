...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        # count = self.cornerscount
        corner = list(self.corners)
        # print(count)
        # while count != 4:
        #     for i in corner:
        #         if state[1] == i:
        ...
        # while len(corner) != 0:
        #     for i in corner:
        #         if state not in CornersProblem.visitedGoal:
        #             visitedGoal.append(state)
        #             print(visitedGoal)
        #             if state == i:
        #                 corner.pop(state)
        #                 # self.corners = corner
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                for i in visited:
                    if i != nextState:
                        unvisited.append(i)
                successors.append(((nextState, tuple(unvisited)), action, 1))
